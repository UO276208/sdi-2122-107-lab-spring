...
class NotaneitorApplicationTests {
    ...
    static String Geckodriver = "C:\\Users\\Usuario\\Desktop\\SDI\\sesion06\\PL-SDI-Sesión5-material\\geckodriver-v0.30.0-win64.exe";
...
// Propiedad: Error.signup.dni.duplicate
    ...
    public void PR010() {
        ...
        PO_HomeView.clickOption(driver, "login", "class", "btn btn-primary");
        //Rellenamos el formulario
        PO_LoginView.fillLoginForm(driver, "99999990A", "848");
        //Comprobamos que permanecemos en la pagina de login
